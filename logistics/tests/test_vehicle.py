...
class TestVehicleAPI:
    ...
    def provider(self, provider_user):
        return TransportProvider.objects.create(
            name="FastTrans",
            owner=provider_user
        )
    ...
    def test_cannot_assign_more_than_two_drivers(self, vehicle):
        # Tengeneza madereva 3
        driver1 = Driver.objects.create(full_name="Driver One")
        driver2 = Driver.objects.create(full_name="Driver Two")
        driver3 = Driver.objects.create(full_name="Driver Three")
