...
class TransportLegSerializer(serializers.ModelSerializer):
    ...
    def get_shipment_tracking_url(self, obj):
        ...
        if institution and institution.slug:
            return generate_subdomain_url(institution.slug, f"/track/shipment/{obj.shipment.id}/")
        return None
    ...
    def get_provider_dashboard_url(self, obj):
        ...
        if institution and institution.slug:
            return generate_subdomain_url(institution.slug, f"/dashboard/shipments/{obj.shipment.id}/")
        return None
    ...
    def get_receiver_view_url(self, obj):
        ...
        if institution and institution.slug:
            return generate_subdomain_url(institution.slug, f"/view/shipment/{obj.shipment.id}/")
        return None